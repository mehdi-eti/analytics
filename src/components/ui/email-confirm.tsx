function EmailConfirm({ verificationCode }: { verificationCode: string }): string {
  return `
  <!--
...
<style type="text/css">
@media (max-width: 480px) {
.t29,.t34{mso-line-height-alt:0px!important;line-height:0!important;display:none!important}.t30{padding-top:43px!important}.t32{border:0!important;border-radius:0!important}.t9{width:320px!important}
}
</style>
<!--[if !mso]>-->
